...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-11-2022 a las 23:17:09
...
(15, 11, '0000-00-00', '0000-00-00', 0, 0, 0);
...
--
ALTER TABLE `dieta`
  MODIFY `id_dieta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `itemcomidas`
--
ALTER TABLE `itemcomidas`
  MODIFY `id_itemcomida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
